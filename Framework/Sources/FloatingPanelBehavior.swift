...
public protocol FloatingPanelBehavior {
    ...
    ///
    /// The default implementation of this method returns the middle value between the normal and fast deceleration rates of UIScrollView.
...
public extension FloatingPanelBehavior {
    ...
    func momentumProjectionRate(_ fpc: FloatingPanelController) -> CGFloat {
        return ((UIScrollViewDecelerationRateFast - UIScrollViewDecelerationRateNormal) * 0.5) + UIScrollViewDecelerationRateNormal
    }
...
public class FloatingPanelDefaultBehavior: FloatingPanelBehavior {
    ...
    public func interactionAnimator(_ fpc: FloatingPanelController, to targetPosition: FloatingPanelPosition, with velocity: CGVector) -> UIViewPropertyAnimator {
        ...
        animator.isManualHitTestingEnabled = true // Actually let the animator interruptible by the pan gesture of the controller without pausing or stopping it
        return animator
    }
